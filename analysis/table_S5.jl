...
# Table S5 cases: base + three perturbations (higher frequency, higher
# severity, higher recurrence) for each of three life histories.
# "Higher recurrence" maps to the *_longer_duration parameter files.
cases = [
    ("Intermediate", "Base",              "no_RA_intermidiate"),
    ("Intermediate", "Higher frequency",  "no_RA_intermidiate_higher_frequency"),
    ("Intermediate", "Higher severity",   "no_RA_intermidiate_higher_severity"),
    ("Intermediate", "Higher recurrence", "no_RA_intermidiate_longer_duration"),
    ("Fast",         "Base",              "no_RA_short"),
    ("Fast",         "Higher frequency",  "no_RA_short_higher_frequency"),
    ("Fast",         "Higher severity",   "no_RA_short_higher_severity"),
    ("Fast",         "Higher recurrence", "no_RA_short_longer_duration"),
    ("Slow",         "Base",              "no_RA_long"),
    ("Slow",         "Higher frequency",  "no_RA_long_higher_frequency"),
    ("Slow",         "Higher severity",   "no_RA_long_higher_severity"),
    ("Slow",         "Higher recurrence", "no_RA_long_longer_duration"),
]
...
for (life_history, perturbation, case) in cases
    println("\n===== ", life_history, " / ", perturbation, " (", case, ") =====")
    P10, P10_lower, P10_upper,
    P10_no_I, P10_lower_no_I, P10_upper_no_I,
    ratio, r_lower, r_upper,
    n_events, n_events_no_I = calcualte_bankruptcy(case)

    push!(results, (life_history, perturbation, case,
        n_events, n_events_no_I,
        P10, P10_lower, P10_upper,
        P10_no_I, P10_lower_no_I, P10_upper_no_I,
        ratio, r_lower, r_upper))
...
CSV.write("manuscript/table_S5.csv", results)
results
