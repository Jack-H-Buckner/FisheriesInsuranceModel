...
if !isdir("results/no_insurance_$params")
    mkdir("results/no_insurance_$params")
end 
...
function main(params,Nκ, Nη, Ns_grid, Nb_grid, NΔb_grid, Nquad)
    ...
    savefig(plt,"results/no_insurance_$params/check_b_grid.png")
    ...
    savefig(plt,"results/no_insurance_$params/check_s_grid.png")
    ...
    savefig(plt,"results/no_insurance_$params/check_u_grid.png")
    ...
    save_solution(prob,"results/no_insurance_$params/sol.jld2")
    ...
    savefig(plt,"results/no_insurance_$params/simulation.png")

    plt = plot_premiums(prob)
    savefig(plt,"results/no_insurance_$params/premiums.png")

    plt = plot_value_function(prob)
    savefig(plt,"results/no_insurance_$params/value_function.png")
end
